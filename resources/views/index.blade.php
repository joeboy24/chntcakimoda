...
@section('navlist')
  ...
  <li class="nav-item cta"><a href="" class="nav-link" data-toggle="modal" data-target="#modalRequest"><span>Apply Now</span></a></li>
...
<section class="home-slider owl-carousel">
  {{-- @for ($i = 1; $i < 4; $i++) --}}
    <div class="slider-item" style="background-image: url(/storage/classified/system_use/{{$homepage->img1_photo}});">
      ...
      <div class="container">
        <div class="row slider-text align-items-center" data-scrollax-parent="true">
          <div class="col-md-6 col-sm-12 ftco-animate" data-scrollax=" properties: { translateY: '70%' }">
            ...
            <p data-scrollax="properties: { translateY: '30%', opacity: 1.6 }"><a href="#" class="btn btn-primary px-4 py-3">Start Application</a></p>
          </div>
        </div>
      </div>
    </div>
    <div class="slider-item" style="background-image: url(/storage/classified/system_use/{{$homepage->img2_photo}});">
      <div class="overlay"></div>
      <div class="container">
        <div class="row slider-text align-items-center" data-scrollax-parent="true">
          <div class="col-md-6 col-sm-12 ftco-animate" data-scrollax=" properties: { translateY: '70%' }">
    ...
    <div class="slider-item" style="background-image: url(/storage/classified/system_use/{{$homepage->img3_photo}});">
      <div class="overlay"></div>
      <div class="container">
        <div class="row slider-text align-items-center" data-scrollax-parent="true">
          <div class="col-md-6 col-sm-12 ftco-animate" data-scrollax=" properties: { translateY: '70%' }">
  ...
  <div class="row">
      ...
      <div class="row">
        {{-- <div class=""> --}}
          ...
          <div class="event_container">
            <img src="/storage/classified/system_use/0122_0937fb5.jpeg" width="100%">
    ...
    <div class="col-md-8 events_right">
      ...
      <div class="row">
        ...
        <button type="button" class="btn_red_inverse">Load More</button>
    </div>
  </div>
</section>
  ...
  <div class="freshers">
    ...
    <div class="freshers_left">
      ...
      <h3>The School currently runs a 3year 
        ...
        The options are: Paediatrics Nursing, General Nursing, 
        Mental Health Nursing, Community Nursing and Midwifery.
      </h3>
    </div>
  ...
  <div class="container">
    <div class="row">
      <div class="col-md-6 admi_left">
        ...
        <h2>Registration</h2>
        <h3>Gone Digital</h3>
        <button type="button" class="admi_inverse">Register Now</button>
  ...
  <div class="container-wrap">
    <div class="row no-gutters">
        @foreach ($gallery as $item)
          <div class="col-md-3 ftco-animate">
              <a href="#" class="gallery img d-flex align-items-center" style="background-image: url(/storage/classified/gallery/{{$item->photo}});">
