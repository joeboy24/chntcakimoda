        ...
        <div class="container" data-scrollax-parent="true">
          <div class="row slider-text align-items-end">
            <div class="col-md-7 col-sm-12 ftco-animate mb-5">
              ...
              <h1 class="mb-3" data-scrollax=" properties: { translateY: '70%', opacity: .9}">Our Current Events</h1>
            </div>
          </div>
        </div>
      </div>
							...
							@foreach ($events as $event)
								<div class="col-md-12 ftco-animate">
									<div class="blog-entry">
										<a href="" class="block-20" style="background-image: url('/storage/classified/events/{{$event->dp}}');">
										</a>
										<div class="text d-flex py-4">
											<div class="meta mb-3">
												<div><a href="#">{{$event->date_added}}</a></div>
							...
							@foreach ($blogs as $blog)
								@if ($i++ < 4)
									<div class="block-21 mb-4 d-flex">
										<a href="/dash/{{ $blog->id }}" class="blog-img mr-4" style="background-image: url(/storage/classified/news_blog/{{$blog->dp}}); border-radius: 5px"></a>
										<div class="text">
											<h3 class="heading"><a href="/dash/{{ $blog->id }}"> {{ substr($blog->text, 0, 60) }}...</a></h3>
											<div class="meta">
