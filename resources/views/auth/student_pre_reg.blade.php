                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="">
                                        ...
                                        <div class="position-relative">
                                            <input type="text" name="fname" class="" placeholder="eg. John" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="">
                                        ...
                                        <div class="position-relative">
                                            <input type="text" name="sname" class="" placeholder="eg. Doe" required>
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="">
                                        ...
                                        <div class="position-relative">
                                            <input type="text" name="guardian" class="" placeholder="Guardian's Full Namne" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="">
                                        ...
                                        <div class="position-relative">
                                            <input type="password" class="" name="password" placeholder="Password" required autocomplete="current-password">
                                        </div>
                                    </div>
                                    ...
                                    <script>
                                        ...
                                        function passCheck() {
                                            ...
                                            if (pass1.length == pass2.value && pass1 != pass2 ) {
                                            document.getElementById("note1").style.display = "block";
                                                // document.getElementById("note1").innerHtml = "Passwords do not match";
                                            }
                                        }
                                    </script>
