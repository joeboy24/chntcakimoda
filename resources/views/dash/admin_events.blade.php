                                    ...
                                    @foreach ($events as $event)
                                        ...
                                        @endif
                                            ...
                                            <td class="text-bold-500"><p class="small_p">Title: {{ $event->title }}</p>
                                                <p class="gray_p">Event Date: {{ $event->date_added }}</p>{{ $event->text }}<br>
                                                    ...
                                                    <form action="{{ action('DashController@update', $event->id) }}" method="POST">
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            <div class="col-md-12">
                                                                ...
                                                                <div class="form-group has-icon-left">
                                                                    <div class="position-relative">
                                                                        <input name="ev_date_added" type="date" class="form-control" placeholder="mm/dd/yyyy" id="first-name-icon" value="{{ $event->date_added }}" required>
                                                                        <div class="form-control-icon">
                                                                            <i class="bi bi-person"></i>
                                                                        </div>
                                                                    </div>
                                                            ...
                                                            <div class="col-md-12">
                                                                ...
                                                                <div class="form-group has-icon-left">
                                                                    <div class="position-relative">
                                                                        <input name="ev_duration" type="text" class="form-control" placeholder="ex. 6:30 pm - 1:00 am" id="first-name-icon" value="{{ $event->title }}" required>
                                                                        <div class="form-control-icon">
                                                                            <i class="bi bi-person"></i>
                                                                        </div>
                                                                    </div>
